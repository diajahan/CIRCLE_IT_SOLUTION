...
selling_total,delivery_charge,customer_charge,date) VALUES ('9643','$shipping_address','$_POST[customer_name]','$_POST[phone]',
...
for($i=0; $i<count($array2); $i++)
{
        ...
        $s.="('".$order_id."','9643','".$row5['id']."','".$row5['supplier_id']."','".$array2[$i]['prod_size']."','".$row5['purchase_price']."',
